...
generate_training_data_for_rnet(pnet, detection_meta, args.output_folder, crop_size=32, suffix='rnet')
print("Done")

print("Start generate classification and bounding box regression eval data.")
generate_training_data_for_rnet(pnet, detection_eval_meta, args.output_folder, crop_size=32, suffix='rnet_eval')
print("Done")
